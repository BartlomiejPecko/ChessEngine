...
public class Pawn extends Piece{
    ...
    @Override
    public Pawn movePiece(final Moves move) {
        return new Pawn(move.getMovedPiece().getPieceAlliance(), move.getPieceDestination()); //creates new pawn onto moved location of prev one
    }
    @Override
